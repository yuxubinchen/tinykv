...
const (
	...
	MessageType_MsgHup MessageType = 0 //开始一个新的选举
	...
	MessageType_MsgTimeoutNow MessageType = 12 //从领导者发送到领导者转移目标，让转移目标立即超时并开始新的选举。
)
